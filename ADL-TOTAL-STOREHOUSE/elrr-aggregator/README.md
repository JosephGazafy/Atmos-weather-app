...
## Other Projects
- In order to build Aggregator, you will need to have cloned and installed the [ELRR Entities library](https://github.com/adlnet/elrr-services-entities) (on which this project depends).
